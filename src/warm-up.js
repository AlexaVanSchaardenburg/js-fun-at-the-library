...
var sequel = `The Alice Network, sequel to ${title}`
...
if (pages < 1000){
    ...
    console.log('Ok, maybe I couldread that in a day and a half.')
}
...
if (isFav){
    console.log(`${title} is my favorite book`)
} else {
    console.log(`I only recently read ${title}`)
}
...
var books = ['The Alice Network', 'The Huntress', 'The Diamond Eye', 'Cinder', 'The Martian']
...
var belowTwoHundred = [40, 67, 100, 168, 140, 5, 30, 20, 95, 12]
